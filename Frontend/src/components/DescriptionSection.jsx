...
const DescriptionSection = ({ isProduct, description, data }) => {
  return (
    <div className="bg-white font-StoryScript overflow-hidden p-3 lg:p-12">
      <div className="pt-6 border-t border-gray-100">
        <h3 className="text-xl font-semibold mb-4 text-gray-900">
          {isProduct ? 'Product Details' : 'Bundle Details'}
        </h3>
        <p className="text-gray-600 font-PatrickHand  leading-relaxed">{description}</p>

        {!isProduct && (
          <div className="mt-4 p-4 font-StoryScript bg-purple-50 rounded-xl">
